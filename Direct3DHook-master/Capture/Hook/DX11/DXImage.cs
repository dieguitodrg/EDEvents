...
namespace Capture.Hook.DX11
{
    public class DXImage : Component
    {
        ...
        public bool Initialise(System.Drawing.Bitmap bitmap)
        {
            ...
            Bitmap copiedBitmap = new Bitmap(bitmap.Width, bitmap.Height);
            ...
            System.Drawing.Imaging.BitmapData bmData = copiedBitmap.LockBits(new System.Drawing.Rectangle(0, 0, _texWidth, _texHeight), System.Drawing.Imaging.ImageLockMode.ReadOnly, System.Drawing.Imaging.PixelFormat.Format32bppArgb);
            ...
            copiedBitmap.UnlockBits(bmData);
