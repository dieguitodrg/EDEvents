    ...
    public partial class Form1 : Form
    {
        ...
        private void btnDisplayOverlay_Click(object sender, EventArgs e)
        {
            _captureProcess.CaptureInterface.DrawOverlayInGame(new Capture.Hook.Common.Overlay
            {
                ...
                {
                    new Capture.Hook.Common.FramesPerSecond(new System.Drawing.Font("Euro Caps", 24, FontStyle.Regular)) {
                            Location = new Point(25, 25),
                            Color = Color.FromArgb(0xff,0xb0, 0),
                            AntiAliased = true,
                            Text = "{0:N0} fps"
                        },
                    new Capture.Hook.Common.ImageElement("C:\\Users\\diegu\\OneDrive\\Imágenes\\Xbox Screenshots\\PngItem_242555.png")
                    {
                        Location=new Point(0, 0)
                    },
                    new Capture.Hook.Common.TextElement(new System.Drawing.Font("Euro Caps", 24, FontStyle.Bold)) {
